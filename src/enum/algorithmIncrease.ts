...
export const POWER_PENETRATION_A_MAIN: AttributeAddObj = {
    "attribute": RoleAttribute.POWER_PENETRATION,
    "increaseMethod": AddOrPerAdd.ADD,
    "value": 20
}
//百分比算力穿透
...
export const REGENERATION_MAIN: AttributeAddObj = {
    "attribute": RoleAttribute.REGENERATION,
    "increaseMethod": AddOrPerAdd.ADD,
    "value": 720
}
// 主属性 单格的最大属性 C区
...
export const MINIMUMTHRESHOLD: AttributeAddObj = {
    "attribute": RoleAttribute.ATTACK_RECOVERY,
    "increaseMethod": AddOrPerAdd.ADD,
    "value": 10
}
// DATA_RECOVERY,//数据复原
...
export const DEDUCE: AttributeAddObj = {
    "attribute": RoleAttribute.ATTACK_SPEED,
    "increaseMethod": AddOrPerAdd.ADD,
    "value": 30
}
