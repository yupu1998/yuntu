import { roleAllAttribute,roleTotalAttribute,roleBaseAttribute } from '../../../dto/storageDtos'
...
/**
 * 传入人形完整属性，返回人形数值属性，或者直接返回空值的人形数值属性
 * @param intput 
 * @returns 
 */
export function getRoleTotalAttribute(intput:undefined|roleAllAttribute = undefined){
