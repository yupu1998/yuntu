...
import { AttributeAddObj, roleTotalAttribute } from '../../../dto/storageDtos'
/**
...
export const selectRole = (k: string) => {
    ...
    return {
        role: k,
        baseData: roleDefaultData[k] as roleTotalAttribute,
 ...
 * @param newData 
 */
export const updateRoleData = (code:string,newData: roleTotalAttribute) => {
